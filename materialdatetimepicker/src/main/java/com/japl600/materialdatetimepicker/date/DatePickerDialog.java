...
package com.japl600.materialdatetimepicker.date;
...
public class DatePickerDialog extends DialogFragment implements
  ...
  private final Calendar mPersianCalendar = Calendar.getInstance();
  ...
  public void initialize(OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
    mCallBack = callBack;
    mPersianCalendar.set(year, monthOfYear, dayOfMonth);
    mThemeDark = false;
  }
  ...
  public void onSaveInstanceState(@NonNull Bundle outState) {
    ...
    outState.putInt(KEY_SELECTED_YEAR, mPersianCalendar.get(Calendar.YEAR));
    outState.putInt(KEY_SELECTED_MONTH, mPersianCalendar.get(Calendar.MONTH));
    outState.putInt(KEY_SELECTED_DAY, mPersianCalendar.get(Calendar.DAY_OF_MONTH));
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    okButton.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        tryVibrate();
        if (mCallBack != null) {
          mCallBack.onDateSet(DatePickerDialog.this, mPersianCalendar.get(Calendar.YEAR),
            mPersianCalendar.get(Calendar.MONTH), mPersianCalendar.get(Calendar.DAY_OF_MONTH));
        }
        dismiss();
      }
    });
  ...
  private void setCurrentView(final int viewIndex) {
    ...
    switch (viewIndex) {
      case MONTH_AND_DAY_VIEW:
        ...
        String dayString = SDF.format(mPersianCalendar.getTime());
      ...
      case YEAR_VIEW:
        ...
        String yearString = String.valueOf(mPersianCalendar.get(Calendar.YEAR));
  ...
  private void updateDisplay(boolean announce) {
    if (mDayOfWeekTextView != null) {
      mDayOfWeekTextView.setText(mPersianCalendar.get(Calendar.DAY_OF_WEEK));
    }

    mYearView.setText(String.valueOf(mPersianCalendar.get(Calendar.YEAR)));
    mSelectedMonthTextView.setText(mPersianCalendar.getDisplayName(Calendar.MONTH, Calendar.LONG, Locale.getDefault()));
    mSelectedDayTextView.setText(String.valueOf(mPersianCalendar.get(Calendar.DAY_OF_MONTH)));

    // Accessibility.
    long millis = mPersianCalendar.getTimeInMillis();
    mAnimator.setDateMillis(millis);
    String monthAndDayText =
      mPersianCalendar.getDisplayName(Calendar.MONTH, Calendar.LONG, Locale.getDefault()) + " " +
        mPersianCalendar.get(Calendar.DAY_OF_MONTH)
    ;
    mMonthAndDayView.setContentDescription(monthAndDayText);

    if (announce) {
      String fullDateText = SDF.format(mPersianCalendar.getTime());
...
//        } TODO
  ...
  public void onYearSelected(int year) {
    ...
    mPersianCalendar.set(year, mPersianCalendar.get(Calendar.MONTH),
      mPersianCalendar.get(Calendar.DAY_OF_MONTH));
    updatePickers();
    setCurrentView(MONTH_AND_DAY_VIEW);
    updateDisplay(true);
  ...
  public void onDayOfMonthSelected(int year, int month, int day) {
    mPersianCalendar.set(year, month, day);
    updatePickers();
    updateDisplay(true);
  }
