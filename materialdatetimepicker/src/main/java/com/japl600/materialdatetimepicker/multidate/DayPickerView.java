...
import com.japl600.materialdatetimepicker.multidate.MultiDatePickerDialog.OnDateChangedListener;
...
//        }
    ...
    public void onDateChanged() {
        ...
        persianCalendar.set(mController.getSelectedYear()
                , persianCalendar.get(Calendar.MONTH), persianCalendar.get(Calendar.DAY_OF_MONTH));
    ...
    private static String getMonthAndYearString(MonthAdapter.CalendarDay day) {
        Calendar mPersianCalendar = Calendar.getInstance();
        mPersianCalendar.set(day.year, day.month, day.day);

        String sbuf = "";
        sbuf += mPersianCalendar.get(Calendar.MONTH);//TODO try the name of the month
        sbuf += " ";
        sbuf += mPersianCalendar.get(Calendar.YEAR);
        return sbuf;
    }
