...
import com.japl600.materialdatetimepicker.multidate.MonthView.OnDayClickListener;
...
public abstract class MonthAdapter extends BaseAdapter implements OnDayClickListener {
    ...
    private final ArrayList<Calendar> mSelectedDays;
    ...
    public static class CalendarDay {
        private Calendar mPersianCalendar;
        int year;
        int month;
        int day;
        ...
        private void setTime(long timeInMillis) {
            ...
            year = mPersianCalendar.get(Calendar.YEAR);
            month = mPersianCalendar.get(Calendar.MONTH);
        ...
        public Calendar getPersianCalendar() {
            if (mPersianCalendar != null)
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        for (Calendar persianCalendar : mSelectedDays)
            if (isSelectedDayInMonth(new CalendarDay(persianCalendar), year, month))
                days.add(persianCalendar.get(Calendar.DAY_OF_MONTH));
    ...
    private void notifySelectedDays(CalendarDay day) {
        ...
        for (Calendar calendarDay : mSelectedDays)
        ...
        if (mSelectedDays.size() > 1 && toRemove != null)
            ...
            Collections.sort(mSelectedDays, new Comparator<Calendar>() {
                @Override
